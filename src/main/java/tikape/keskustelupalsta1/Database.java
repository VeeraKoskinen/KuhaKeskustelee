...
//    }
    ...
    private List<String> postgreLauseet() {
        ...
        lista.add("CREATE TABLE Viesti (Id serial PRIMARY KEY, Keskustelu integer NOT NULL, Nimimerkki varchar(20) NOT NULL, Saapumishetki TIMESTAMP DEFAULT NOW(), Viestisisältö varchar(100000) NOT NULL,FOREIGN KEY (Keskustelu) REFERENCES Keskustelu(KeskusteluId));");
